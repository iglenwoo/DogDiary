...
class MainTabBarViewController: UITabBarController {
    ...
    private func setupVCs() {
        ...
        trackVC.tabBarItem = UITabBarItem(title: "Activity", image: #imageLiteral(resourceName: "pet.png"), tag: 0)
    
        let historyVC = HistoryViewController()
        historyVC.tabBarItem = UITabBarItem(title: "Log", image: #imageLiteral(resourceName: "list.png"), tag: 1)
    
        let settingVC = SettingViewController()
        settingVC.tabBarItem = UITabBarItem(title: "Setting", image: #imageLiteral(resourceName: "setting.png"), tag: 2)
